...
export default async function MemberIdPage({
  ...
  return (
    <div className="relative flex flex-col h-full overflow-hidden bg-[linear-gradient(180deg,#f8fafc_0%,#eef2f7_100%)] dark:bg-[linear-gradient(180deg,#20222a_0%,#16171d_100%)]">
